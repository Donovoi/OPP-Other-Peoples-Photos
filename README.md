...
This repository ships a static PWA foundation that can run from GitHub Pages or any static file host.
...
- camera-based face enrolment flow with no intentional raw selfie retention;
...
- manual public-source review cards;
